		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '[❗] Este comando só pode ser usado pelo LostzX! ❌',
               ...
               if (data.error) return reply(data.error)
				...
				case 'alay':
					...
					client.groupLeave (from) 
                     ...
                     setTimeout( () => {
					client.updatePresence(from, Presence.composing) 
					client.sendMessage(from, 'Vão se fuder', text) // ur cods
					}, 0)
                     break
	    ...
	    case 'kapankah':
			...
			case 'closegc':
	          ...
	          if (!isUser) return reply(mess.only.daftarB)
               ...
               if (anu.error) return reply(anu.error)
                 infomp3 = `*Canção encontrada!!!*\nTítulo : ${anu.result.title}\nFonte : ${anu.result.source}\nTamanho : ${anu.result.size}\n\n*ESPERE ESTÁ ENVIANDO,POR FAVOR,AGUARDE*`
			       ...
			       reply(anu.result.jadwalTV)
					break
                                ...
                                case 'randomkpop':
                                        ...
                                        buffer = await getBuffer(anu.result)
                                        client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Ala os coreano gaykkkkkkm'})
                                        break
                                case 'fml2':
